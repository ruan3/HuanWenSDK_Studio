package com.example.hipermisson;
...
//        View permissionView = View.inflate(getContext(), ResLoader.getLayout(getContext(),"dialog_request_permission"), this);
        mTvTitle = (TextView) permissionView.findViewById(R.id.tvTitle);
        mTvTitle = (TextView) permissionView.findViewById(ResLoader.getId(getContext(),"tvTitle"));
        mLlRoot = (LinearLayout) permissionView.findViewById(R.id.llRoot);
//        mLlRoot = (LinearLayout) permissionView.findViewById(ResLoader.getId(getContext(),"llRoot"));
        mTvDesc = (TextView) permissionView.findViewById(R.id.tvDesc);
//        mTvDesc = (TextView) permissionView.findViewById(ResLoader.getId(getContext(),"tvDesc"));
        mBtnNext = (Button) permissionView.findViewById(R.id.goto_settings);
//        mBtnNext = (Button) permissionView.findViewById(ResLoader.getId(getContext(),"goto_settings"));
        mGvPermission = (GridView) permissionView.findViewById(R.id.gvPermission);
//        mGvPermission = (GridView) permissionView.findViewById(ResLoader.getId(getContext(),"gvPermission"));
    }
    ...
    public void setStyleId(int styleId) {
        ...
        /*int[] ints = {
                ResLoader.getInteger(getContext(),"PermissionMsgColor"),
                ResLoader.getInteger(getContext(),"PermissionTitleColor"),
                ResLoader.getInteger(getContext(),"PermissionItemTextColor"),
                ResLoader.getInteger(getContext(),"PermissionButtonTextColor"),
               ResLoader.getInteger(getContext(),"PermissionBackround"),
                ResLoader.getInteger(getContext(),"PermissionButtonBackground"),
                ResLoader.getInteger(getContext(),"PermissionBgFilterColor"),
                ResLoader.getInteger(getContext(),"PermissionIconFilterColor")
        };*/
